...
non_opt_para = {
    ...
    "init_checkpoint": "/gpfs/data/fs71468/GenAI_para_runs/GenAI_VAE/results/vae_2_ITCN_FINAL/TorchTrainer_906cb_00000_0_2023-06-16_11-52-54/checkpoint_000000",                              # load previously saved checkpoint (only training)
