...
non_opt_para = {
    "run_name": "tune_devdata2_independentTCN",
...
config = {
    ...
    # encoder
    "encoder_fun_tcn_units": tune.choice([128, 256, 512]),
    "encoder_fun_hidden_dim": tune.choice([128, 256, 512]),
    "encoder_kernel_size": tune.randint(2, 12),
    "encoder_fun_tcn_layers": tune.randint(2, 10),
    # decoder
    "decoder_fun_tcn_units": tune.choice([128, 256, 512]),
    "decoder_fun_hidden_dim": tune.choice([128, 256, 512]),
    "decoder_kernel_size": tune.randint(2, 10),
    "decoder_fun_tcn_layers": tune.randint(2, 10),
    # quantiles
