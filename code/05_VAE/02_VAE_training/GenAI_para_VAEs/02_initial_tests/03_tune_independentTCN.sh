...
#SBATCH --output=03_tune_independentTCN.out
...
/gpfs/data/fs71468/GenAI_para_runs/miniconda3/envs/GenAI_VAE/bin/python3 -u 03_tune_independentTCN.py > 03_tune_independentTCN.pyout
