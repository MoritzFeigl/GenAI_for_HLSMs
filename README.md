...
* [basin_results.csv](basins_results.csv) – Modeling results (NSE/KGE) for all basins used in the study
* [study_basins.csv](study_basins.csv) – Basin metadata, including gauge characteristics, data sources, and train/validation assignments
