...
#SBATCH --output=tune_vae1_devdata2_MTCN.out

cd /gpfs/data/fs71468/GenAI_para_runs/GenAI_VAE/GenAI_VAE/utils
...
/gpfs/data/fs71468/GenAI_para_runs/miniconda3/envs/GenAI_VAE/bin/python3 -u tune_vae1_devdata2_MTCN.py > tune_vae1_devdata2_MTCN.pyout
