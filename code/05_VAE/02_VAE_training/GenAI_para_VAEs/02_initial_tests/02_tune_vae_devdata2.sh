...
#SBATCH --output=02_tune_vae_devdata2.out
...
/gpfs/data/fs71468/GenAI_para_runs/miniconda3/envs/GenAI_VAE/bin/python3 -u 02_tune_vae_devdata2.py > 02_tune_vae_devdata2.pyout
exit
