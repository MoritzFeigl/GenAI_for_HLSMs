...
non_opt_para = {
    "run_name": "vae_" + str(vae) + "_ITCN_1Node",    # defines name of result dir: results/run_name
    ...
    "val_size": 0.7,                                    # fraction of train data used for validation
    "epochs": 50,                                      # max number of epochs
    "epoch_stop": 1,                                   # number of epochs after which training is stopped --> <3 days!
    ...
    "init_checkpoint": "/gpfs/data/fs71468/GenAI_para_runs/GenAI_VAE/results/vae_5_ITCN_1Node/TorchTrainer_c43ac_00000_0_2023-04-07_21-02-39/checkpoint_000000",                              # load previously saved checkpoint (only training)
