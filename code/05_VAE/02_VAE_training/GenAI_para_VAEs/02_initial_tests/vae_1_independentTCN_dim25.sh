...
#SBATCH --output=vae_1_independentTCN_dim25.out
...
/gpfs/data/fs71468/GenAI_para_runs/miniconda3/envs/GenAI_VAE/bin/python3 -u GenAI_para-ET_VAEs/vae_1_independentTCN_dim25.py > GenAI_para-ET_VAEs/vae_1_independentTCN_dim25.pyout
exit
