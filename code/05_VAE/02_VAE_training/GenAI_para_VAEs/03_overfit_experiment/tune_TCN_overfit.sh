...
#SBATCH --output=tune_TCN_overfit.out
...
/gpfs/data/fs71468/GenAI_para_runs/miniconda3/envs/GenAI_VAE/bin/python3 -u tune_TCN_overfit.py > tune_TCN_overfit.pyout
exit
